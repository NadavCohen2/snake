    ...
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Paint(object sender, PaintEventArgs e)
        {
          ...
          // ציור הנחש
            ...
            gr.DrawLine(p, 800, 0, 800, 720);
            gr.DrawLine(p, 80, 0, 80, 720);
            gr.DrawLine(p, 80, 720, 800, 720);
            gr.DrawLine(p, 80, 0, 800, 0);
        ...
        {
            if (this.last.GetX() <= 70 || this.last.GetX() >= 800 || this.last.GetY() <= -10 || this.last.GetY() >= 720)
                Lose = true;
        }
